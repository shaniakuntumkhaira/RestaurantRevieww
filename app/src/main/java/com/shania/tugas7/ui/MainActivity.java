...
import com.shania.tugas7.data.response.CustomerReviewsItem;
import com.shania.tugas7.data.response.PostReviewResponse;
import com.shania.tugas7.data.response.Restaurant;
import com.shania.tugas7.data.response.RestaurantResponse;
import com.shania.tugas7.data.retrofit.ApiConfig;
import com.shania.tugas7.databinding.ActivityMainBinding;
import com.shania.tugas7.ui.ReviewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID, "Sarah", review);
